...
namespace HQFramework.Editor
{
    ...
    public static class ScriptingDefineSymbols
    {
        ...
        public static bool HasScriptingDefineSymbolAll(string scriptingDefineSymbol)
        {
            bool result = true;
            for (int i = 0; i < BuildTargetGroups.Length; i++)
            {
                result = result && HasScriptingDefineSymbol(BuildTargetGroups[i], scriptingDefineSymbol);
            }
            return result;
        }
